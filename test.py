...
def shapefile_geometric_relations_operations(_input_shapefile_1, _input_shapefile_2, result_shapfile, action=1):
    ...
    for i in range(84):
        ...
        out_shapefile = "2010_{0}_{1}条带".format(i * 500 + 500, i * 500 + 1000)
...
if __name__ == '__main__':
    _input_shapefile_1 = 'E:\\城市与区域生态\\大熊猫和竹\\道路对大熊猫栖息地的影响\\道路距离分析\\2000缓冲区空\\2000一类'
    _input_shapefile_2 = 'E:\\城市与区域生态\\大熊猫和竹\\道路对大熊猫栖息地的影响\\道路距离分析\\2000缓冲区空\\2000一类'
    result_shapfile = 'E:\\城市与区域生态\\大熊猫和竹\\道路对大熊猫栖息地的影响\\道路距离分析\\2000条带空'
